 ...
 */
function odata_preprocess_page(&$vars) {
 ...
 */
function odata_breadcrumb($variables) {
  if (drupal_is_front_page()) {
    return;
  }
 ...
 */
function odata_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function odata_menu_local_task($variables) {
 ...
 * @ingroup themeable
 */
function odata_facetapi_link_inactive($variables) {
 ...
 * @ingroup themeable
 */
function odata_facetapi_link_active($variables) {
  // Sanitizes the link text if necessary.
  $sanitize = empty($variables['options']['html']);
 ...
 * Theme social icons.
 */
function odata_sitewide_social_block() {
 ...
 */
function odata_form_alter(&$form, &$form_state, $form_id) {
  switch ($form_id) {
 ...
 */
function odata_file_widget($variables) {
