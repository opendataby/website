 ...
 */
function data_radix_link_iframe_formatter_original($variables) {
 ...
 */
function data_radix_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function data_radix_facetapi_link_inactive($variables) {
 ...
 * @ingroup themeable
 */
function data_radix_facetapi_link_active($variables) {
  // Sanitizes the link text if necessary.
  $sanitize = empty($variables['options']['html']);
 ...
 * Theme social icons.
 */
function data_radix_sitewide_social_block() {
 ...
 */
function data_radix_file_widget($variables) {
 ...
 */
function data_radix_user_picture(&$variables) {
