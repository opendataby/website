...
/**
 * @file
 * Theme setting callbacks for the odata theme.
 */

/**
 * Implements hook_form_system_theme_settings_alter().
 */
function odata_form_system_theme_settings_alter(&$form, &$form_state) {
  // Hero fieldset.
  $form['hero'] = array(
    '#type' => 'fieldset',
    '#title' => t('Hero Unit'),
  ...
  $form['#submit'][] = 'odata_settings_submit';
}

/**
 * Implements hook_setings_submit().
 */
function odata_settings_submit($form, &$form_state) {
  $settings = array();
